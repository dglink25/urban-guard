<x-app-layout>
    <div class="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto">
        ...
        <div class="flex items-center space-x-4 mb-6">
            <a href="{{ route('communes.index') }}" class="text-gray-500 hover:text-indigo-600 transition">
        ...
        <form method="POST" action="{{ route('communes.update', $commune) }}" 
            ...
            <!-- Champ Département -->
            <div>
                <label for="id_departement" class="block text-sm font-medium text-gray-700 mb-2">
                ...
                >
                    ...
                    @foreach($departements as $departement)
                        <option 
                            ...
                            @selected(old('id_departement', $commune->id_departement) == $departement->id)
                        >
                            {{ $departement->name }}
                        </option>
                    @endforeach
            ...
            <div class="flex justify-end pt-4">
                ...
                >
                    <i class="fas fa-edit mr-2"></i> Mettre à jour la Commune
                </button>
            </div>
        </form>
    </div>
