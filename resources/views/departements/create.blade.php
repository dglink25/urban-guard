<x-app-layout>
    <div class="max-w-xl mx-auto p-6">
        <h1 class="text-2xl font-bold text-blue-700 mb-4">Ajouter un département</h1>

        <form method="POST" action="{{ route('departements.store') }}" class="bg-white shadow-md rounded-lg p-6 space-y-4">
            @csrf
            <div>
