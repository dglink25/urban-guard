<x-app-layout>
    <div class="max-w-xl mx-auto p-6">
        <h1 class="text-2xl font-bold text-blue-700 mb-4">Ajouter un arrondissement</h1>

        <form method="POST" action="{{ route('arrondissements.store') }}" class="bg-white shadow-md rounded-lg p-6 space-y-4">
            @csrf
            ...
            <div class="text-right">
                <button type="submit"
                    class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Enregistrer</button>
            </div>
        </form>
    </div>
